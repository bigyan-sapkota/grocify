...
import { GroceryItemCategory, GroceryItemPriority } from "../../../types";

const categories: GroceryItemCategory[] = [
  "Produce",
  "Dairy",
  "Bakery",
  "Pantry",
...
export default function PlannerFormCard() {
  ...
  const [category, setCategory] = useState<GroceryItemCategory>("Produce");
    ...
    <View className="rounded-3xl border border-border bg-card p-4">
      ...
      <View className="mt-2 flex-row items-center rounded-2xl border border-border bg-muted px-4 py-3">
        <TextInput
          ...
          placeholderTextColor="#8aa937"
        ></TextInput>
      </View>

      <Text className="text-sm mt-4 font-semibold text-foreground">
        Quantity
      </Text>
      <View className="mt-2 flex-row items-center rounded-2xl border border-border bg-muted px-4 py-3">
        <TextInput
